...
y_upper = 100  # upper limit of y axis
...
fig_size = 15  # figure size of the graph
...
color_plot_list = [[0 for y in range(cols)]for x in range(rows)]  # 1 if pixel color is black
fig_plot_list = [[0 for y in range(cols)]for x in range(rows)]  # tell occupying figure of a pixel
